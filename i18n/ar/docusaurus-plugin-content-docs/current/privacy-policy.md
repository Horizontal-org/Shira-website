...
#### كيف نشارك و نكشف عن بيانات الوظائف؟ {#how-do-we-share-or-disclose-functionality-data}
...
تُجمع بيانات القياس عن بُعد تلقائياً عبر [Divvi Up](https://divviup.org/)، وهي
خدمة قياس عن بُعد تحترم الخصوصية. وبفضل Divvi Up، يتم إخفاء هوية كافة البيانات
لضمان عدم الكشف عن أي معلومات حساسة أو معلومات تحدد الهوية الشخصية للمستخدمين.

هذه هي الطريقة التي نتبعها في جمع بيانات القياس عن بُعد:
- جميع البيانات مجهولة المصدر ومُجمَّعة: تُقسِّم مكتبة Divvi Up البيانات إلى
...
- إننا نجمع أقل قدر ممكن من البيانات: حتى وإن كانت جميع البيانات مجهولة، فإننا
  نقلل دائما كمية البيانات التي نجمعها.

#### كيف نقوم بمشاركة أو الإفصاح عن بيانات القياس عن بُعد؟ {#how-do-we-share-or-disclose-telemetry}
لن نقوم أبداً ببيع بيانات القياس عن بُعد الخاصة بكم لأي جهة خارجية. كما لن نقوم
