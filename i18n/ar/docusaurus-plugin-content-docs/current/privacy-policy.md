...
slug: /privacy-policy
sidebar_position: 11
description: ar-Learn how Shira and Horizontal collect, use, and protect user data, including account data, functionality data, telemetry, and privacy rights.
---
...
## ar-2. Data collected {#data-collected}
...
### ar-Account data {#account-data}
#### ar-What is account data? {#what-is-account-data}
...
#### ar-What account data do we collect? {#what-account-data-do-we-collect}
...
#### ar-How do we collect account data? {#how-do-we-collect-account-data}
...
#### ar-How do we share or disclose account data? {#how-do-we-share-or-disclose-account-data}
...
### ar-Functionality data {#functionality-data}

#### ar-What is functionality data? {#what-is-functionality-data}
...
#### ar-What functionality data do we collect? {#what-functionality-data-do-we-collect}
...
#### ar-How is functionality data collected? {#how-is-functionality-data-collected}
We collect functionality data automatically from user inputs as they make use of Shira features.

#### ar-How do we share or disclose functionality data? {#how-do-we-share-or-disclose-functionality-data}
...
### ar-Telemetry {#telemetry}

#### ar-What is telemetry? {#what-is-telemetry}
...
#### ar-What telemetry do we collect? {#what-telemetry-do-we-collect}
We collect the following telemetry data:
- The day and time when Admins connect to Shira.

#### ar-How is telemetry collected? {#how-is-telemetry-collected}
...
#### ar-How do we share or disclose telemetry? {#how-do-we-share-or-disclose-telemetry}
...
## ar-3. Data security {#data-security}
...
## ar-4. Your California Privacy Rights {#california}
...
## ar-5. Changes to Our Privacy Policy {#changes}
...
## ar-6. Contact Information {#contact}
