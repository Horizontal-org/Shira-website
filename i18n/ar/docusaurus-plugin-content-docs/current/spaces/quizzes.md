...
:::note\
إذا ألغيتم نشر اختبار ما *أثناء إجراء* المتعلم له، سيرى المتعلم رسالة خطأ في
نهاية الاختبار عند محاولته تقديم إجاباته، وسيفقد حينها تقديمه. \
:::
...
:::note\
إذا كان بعض المتعلمين قد أجروا الاختبار بالفعل، فقد يؤثر تحرير هذا الاختبار على
موثوقية [نتائج الاختبار](/results). \
:::
...
:::warning\
إن حذف اختبار أمر لا رجعة فيه: بمجرد حذفه، لن يكون ممكنا استعادة الاختبار
ونتائجه!! \
:::
