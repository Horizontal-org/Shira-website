...
slug: /privacy-policy
sidebar_position: 11
description: Узнайте, как Shira и Horizontal собирают, используют и защищают данные пользователей, включая данные учетных записей, данные о функциональности, телеметрию и права на конфиденциальность.
---
