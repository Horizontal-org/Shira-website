...
slug: /privacy-policy
sidebar_position: 11
description: ru-Learn how Shira and Horizontal collect, use, and protect user data, including account data, functionality data, telemetry, and privacy rights.
---
...
## ru-2. Data collected {#data-collected}
...
#### ru-What is account data? {#what-is-account-data}
...
#### ru-What account data do we collect? {#what-account-data-do-we-collect}
...
#### ru-How do we collect account data? {#how-do-we-collect-account-data}
...
#### ru-How do we share or disclose account data? {#how-do-we-share-or-disclose-account-data}
...
### ru-Functionality data {#functionality-data}

#### ru-What is functionality data? {#what-is-functionality-data}
...
#### ru-What functionality data do we collect? {#what-functionality-data-do-we-collect}
...
#### ru-How is functionality data collected? {#how-is-functionality-data-collected}
We collect functionality data automatically from user inputs as they make use of Shira features.

#### ru-How do we share or disclose functionality data? {#how-do-we-share-or-disclose-functionality-data}
...
### ru-Telemetry {#telemetry}

#### ru-What is telemetry? {#what-is-telemetry}
...
#### ru-What telemetry do we collect? {#what-telemetry-do-we-collect}
We collect the following telemetry data:
- The day and time when Admins connect to Shira.

#### ru-How is telemetry collected? {#how-is-telemetry-collected}
...
#### ru-How do we share or disclose telemetry? {#how-do-we-share-or-disclose-telemetry}
...
## ru-3. Data security {#data-security}
...
## ru-4. Your California Privacy Rights {#california}
...
## ru-5. Changes to Our Privacy Policy {#changes}
...
## ru-6. Contact Information {#contact}
