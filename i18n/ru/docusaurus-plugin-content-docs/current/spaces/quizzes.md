...
slug: /quizzes
sidebar_position: 2
description: Узнайте, как создавать, управлять и настраивать тесты в Shira для обучения вашей команды по вопросам фишинга, включая публикацию, редактирование, дублирование и удаление тестов.
...
::: note\
Если вы отменили публикацию теста *во время* его прохождения учащимся, по
завершении теста при попытке отправить ответы учащемуся будет отображено
...
:::note\
Если некоторые учащиеся уже прошли тест, его редактирование может повлиять на
достоверность [результатов теста](/results). \
:::
...
:::warning\
Удаление теста является необратимым: после удаления тест и его результаты не
