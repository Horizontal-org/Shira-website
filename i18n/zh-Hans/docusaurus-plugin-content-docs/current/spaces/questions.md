...
slug: /questions
sidebar_position: 4
description: zh-Hans-Learn how to create and customize quiz questions in Shira — including preferences, apps, content, and explanations — to teach learners how to identify phishing attempts.
...
## zh-Hans-Creating a question {#create}
...
## zh-Hans-Question preferences {#preferences}
...
## zh-Hans-The question's content {#content}
...
## zh-Hans-Explanations {#explanations}
