...
slug: /privacy-policy
sidebar_position: 11
description: zh-Hans-Learn how Shira and Horizontal collect, use, and protect user data, including account data, functionality data, telemetry, and privacy rights.
---
import TOCInline from '@theme/TOCInline';


# zh-Hans-Privacy policy {#privacy-policy}


<TOCInline toc={toc.filter((node) => node.level === 2)} />


## zh-Hans-1. Introduction {#intro}
...
## zh-Hans-2. Data collected {#data-collected}
...
### zh-Hans-Account data {#account-data}
#### zh-Hans-What is account data? {#what-is-account-data}
...
#### zh-Hans-What account data do we collect? {#what-account-data-do-we-collect}
...
#### zh-Hans-How do we collect account data? {#how-do-we-collect-account-data}
...
#### zh-Hans-How do we share or disclose account data? {#how-do-we-share-or-disclose-account-data}
...
### zh-Hans-Functionality data {#functionality-data}

#### zh-Hans-What is functionality data? {#what-is-functionality-data}
...
#### zh-Hans-What functionality data do we collect? {#what-functionality-data-do-we-collect}
...
#### zh-Hans-How is functionality data collected? {#how-is-functionality-data-collected}
We collect functionality data automatically from user inputs as they make use of Shira features.

#### zh-Hans-How do we share or disclose functionality data? {#how-do-we-share-or-disclose-functionality-data}
...
### zh-Hans-Telemetry {#telemetry}

#### zh-Hans-What is telemetry? {#what-is-telemetry}
...
#### zh-Hans-What telemetry do we collect? {#what-telemetry-do-we-collect}
We collect the following telemetry data:
- The day and time when Admins connect to Shira.

#### zh-Hans-How is telemetry collected? {#how-is-telemetry-collected}
...
#### zh-Hans-How do we share or disclose telemetry? {#how-do-we-share-or-disclose-telemetry}
...
As required by law (e.g. if this data is subpoenaed as part of a court order)
As necessary to operate and provide the services of Shira (e.g. to provide usage data to partners or contractors)

## zh-Hans-3. Data security {#data-security}
...
## zh-Hans-4. Your California Privacy Rights {#california}
...
## zh-Hans-5. Changes to Our Privacy Policy {#changes}
...
## zh-Hans-6. Contact Information {#contact}
