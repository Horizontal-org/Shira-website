...
slug: /quizzes
sidebar_position: 3
description: fr-Learn how to create, manage, and customize quizzes in Shira to train your team on phishing awareness, including publishing, editing, duplicating, and deleting quizzes.
...
## fr-Creating quizzes {#create-quizzes}
...
## fr-Quiz privacy settings {#privacy}
...
## fr-Adding question to your quiz {#questions}
...
## fr-Publishing and unpublishing quizzes {#publish-unpublish}
...
## fr-Editing quizzes {#edit-quizzes}
...
## fr-Duplicating a quiz {#duplicate-quiz}
...
## fr-Deleting a quiz {#delete-quiz}
