...
slug: /questions
sidebar_position: 4
description: es-Learn how to create and customize quiz questions in Shira — including preferences, apps, content, and explanations — to teach learners how to identify phishing attempts.
...
## es-Question preferences {#preferences}
...
## es-The question's content {#content}
