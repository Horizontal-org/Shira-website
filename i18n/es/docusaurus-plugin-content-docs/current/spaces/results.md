...
La sección Resultados proporciona información sobre si las personas han
completado tu cuestionario y qué tan bien les fue en el cuestionario.
...
por estudiantes.
* En cuestionarios públicos, el número de cuestionarios completados no siempre
  es igual al número de estudiantes que han completado el cuestionario (porque
  las personas estudiantes son anónimas, una persona puede completar un
