...
slug: /quizzes
sidebar_position: 3
description: es-Learn how to create, manage, and customize quizzes in Shira to train your team on phishing awareness, including publishing, editing, duplicating, and deleting quizzes.
...
## es-Creating quizzes {#create-quizzes}
...
## es-Quiz privacy settings {#privacy}
...
## es-Adding question to your quiz {#questions}
...
## es-Publishing and unpublishing quizzes {#publish-unpublish}
...
## es-Editing quizzes {#edit-quizzes}
...
## es-Duplicating a quiz {#duplicate-quiz}
...
## es-Deleting a quiz {#delete-quiz}
