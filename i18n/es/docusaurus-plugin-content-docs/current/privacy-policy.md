...
slug: /privacy-policy
sidebar_position: 11
description: es-Learn how Shira and Horizontal collect, use, and protect user data, including account data, functionality data, telemetry, and privacy rights.
---
...
## es-2. Data collected {#data-collected}
...
### es-Account data {#account-data}
#### es-What is account data? {#what-is-account-data}
...
#### es-What account data do we collect? {#what-account-data-do-we-collect}
...
#### es-How do we collect account data? {#how-do-we-collect-account-data}
...
#### es-How do we share or disclose account data? {#how-do-we-share-or-disclose-account-data}
...
### es-Functionality data {#functionality-data}

#### es-What is functionality data? {#what-is-functionality-data}
...
#### es-What functionality data do we collect? {#what-functionality-data-do-we-collect}
...
#### es-How is functionality data collected? {#how-is-functionality-data-collected}
We collect functionality data automatically from user inputs as they make use of Shira features.

#### es-How do we share or disclose functionality data? {#how-do-we-share-or-disclose-functionality-data}
...
### es-Telemetry {#telemetry}

#### es-What is telemetry? {#what-is-telemetry}
...
#### es-What telemetry do we collect? {#what-telemetry-do-we-collect}
We collect the following telemetry data:
- The day and time when Admins connect to Shira.

#### es-How is telemetry collected? {#how-is-telemetry-collected}
...
#### es-How do we share or disclose telemetry? {#how-do-we-share-or-disclose-telemetry}
...
## es-3. Data security {#data-security}
...
## es-4. Your California Privacy Rights {#california}
...
## es-5. Changes to Our Privacy Policy {#changes}
...
## es-6. Contact Information {#contact}
