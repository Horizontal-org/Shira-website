...
2. You can pull ready-made questions from [the Library](/library). If you pull a question from the Library, you can use it as is or adapt it to your specific context and needs.
